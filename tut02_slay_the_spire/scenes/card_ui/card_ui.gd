...
# how the game responds when cards can or cannot be played (mana cost)
var playable : bool = true : set = _set_playable
var disabled : bool = false

func _ready() -> void:
	# initialize the card interaction events
...
func _set_char_stats(value) -> void:
	char_stats = value
...
# ======= Makes sure cards being selected are the only ones that can be interacted with ========
